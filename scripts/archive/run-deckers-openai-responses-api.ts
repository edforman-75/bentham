#!/usr/bin/env npx tsx
/**
 * Deckers Brands US Visibility Study - OpenAI Responses API Surface
 */
...
async function main() {
  ...
  console.log('\n' + '='.repeat(70));
  console.log('  DECKERS BRANDS US VISIBILITY STUDY - OpenAI Responses API');
  ...
  const output = {
    studyName: 'Deckers Brands US Visibility Study - OpenAI Responses API',
